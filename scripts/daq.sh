...
python awq/entry.py --model_path /public/home/acfanoll2u/dataset/llama7b/Llama-2-7b-hf --calibration daq --run_awq --tasks wikitext --w_bit 4 --q_group_size 128 --q_backend fake --dump awq_cache/Llama-2-7b-hf-daq-calibration-channel-nf4.pt --sample 2 --data_type nf
python awq/entry.py --model_path /root/autodl-tmp/abc/Llama-2-7b-hf --calibration daq --run_awq --tasks wikitext --w_bit 4 --q_group_size -1 --q_backend fake --dump awq_cache/Llama-2-7b-hf-daq-sym-dca-channel-nf4.pt --sample 2 --data_type nf4
